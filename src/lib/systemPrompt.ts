...
components) depending on the platform and task. In the first two years she focused on the Dealer Platform
and the Decisioning Engine, migrating legacy systems to a modern hexagonal architecture to improve
testability and maintainability. She was responsible for complex logic that fetches and matches loan terms
from different banks based on the customer's credit score, risk profile and geographical location.
